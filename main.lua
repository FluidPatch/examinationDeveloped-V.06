--==[ SCHAZ ASCII - MEDIUM SIZE BOTTOM FLOAT ]==--

local gui = Instance.new("ScreenGui", game.CoreGui)
gui.Name = "SchazAsciiGui"

local ascii = Instance.new("TextLabel", gui)
ascii.Name = "AsciiArt"
...
-- ✅ Posisi: Kiri bawah, tapi naik dikit dari mentok
ascii.Position = UDim2.new(0.02, 0, 0.86, 0) -- ← bawah tapi gak mentok (0.86 dari 1 = naik dikit)
...
-- 🌈 RGB Gradasi
local gradient = Instance.new("UIGradient", ascii)
...
-- Native Roblox Notification Script (Luau)
-- Place in a LocalScript under StarterPlayerScripts
...
local function sendNotification(title, text, duration, icon)
    ...
    pcall(function() -- Wrap in pcall to prevent crashes
        StarterGui:SetCore("SendNotification", {
            Title = title or "INFINITE-19",
            Text = text or "Developed V.06",
            Duration = duration,
            Icon = icon or "rbxassetid://94356930125612" -- Your asset ID
        })
    end)
end

-- Trigger the notification
sendNotification("INFINITE-19", "Developed V.06", 5, "rbxassetid://136250689886447")
...
ScreenGui.Name = "DukunGhoib"
ScreenGui.ResetOnSpawn = false
ScreenGui.Parent = game.CoreGui

-- Create the main frame (Draggable Teleport GUI)
local frame = Instance.new("Frame")
frame.Size = UDim2.new(0, 300, 0, 400) -- Reverted to original size, not 300x450
frame.Position = UDim2.new(0, 50, 0, 50)
frame.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Darker base color
frame.BorderSizePixel = 0
frame.Active = true -- Enable dragging
frame.Draggable = true
frame.Parent = ScreenGui

-- Add a subtle corner radius for a polished look
...
title.Size = UDim2.new(1, 0, 0, 60) -- Larger title area
title.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
title.Text = "INFINTE-19 EXAMINATION"
title.TextColor3 = Color3.fromRGB(0, 255, 0) -- Green title
...
-- Coordinates label with styled text
...
coords.Text = "HOW WEAK THIS SYSTEM"
...
-- Teleport button 1 with enhanced styling
local teleportBtn1 = Instance.new("TextButton")
teleportBtn1.Size = UDim2.new(0, 250, 0, 50)
teleportBtn1.Position = UDim2.new(0.5, -125, 0, 110)
teleportBtn1.BackgroundColor3 = Color3.fromRGB(0, 0, 139) -- Dark blue
teleportBtn1.Text = "SECTOR 2"
...
-- Teleport button 2 with enhanced styling
...
-- Teleport button 3 with enhanced styling
local teleportBtn3 = Instance.new("TextButton")
...
-- Teleport button 4 with enhanced styling
local teleportBtn4 = Instance.new("TextButton")
...
-- Teleport button 5 with enhanced styling
local teleportBtn5 = Instance.new("TextButton")
...
-- Add click animation and teleport functionality
local tweenService = game:GetService("TweenService")
local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)

local function createTween(button)
    return tweenService:Create(button, tweenInfo, {Size = UDim2.new(0, 260, 0, 55)})
end
...
teleportBtn1.MouseButton1Click:Connect(function()
    ...
    if character and character:FindFirstChild("HumanoidRootPart") then
        ...
        successMsg.Text = "Teleported to -20, -9, -885!"
...
teleportBtn2.MouseButton1Click:Connect(function()
    ...
    if character and character:FindFirstChild("HumanoidRootPart") then
        ...
        successMsg.Position = UDim2.new(0.5, -125, 0, 350)
        successMsg.BackgroundTransparency = 1
        successMsg.Text = "Teleported to -63, -32, -1423!"
        successMsg.TextColor3 = Color3.fromRGB(0, 255, 0)
        successMsg.Font = Enum.Font.Gotham
        successMsg.TextSize = 14
        successMsg.Parent = frame
...
teleportBtn3.MouseButton1Click:Connect(function()
    ...
    if character and character:FindFirstChild("HumanoidRootPart") then
        ...
        successMsg.Position = UDim2.new(0.5, -125, 0, 350)
        successMsg.BackgroundTransparency = 1
        successMsg.Text = "Teleported to 115, -31, -1488!"
        successMsg.TextColor3 = Color3.fromRGB(0, 255, 0)
        successMsg.Font = Enum.Font.Gotham
        successMsg.TextSize = 14
        successMsg.Parent = frame
...
teleportBtn4.MouseButton1Click:Connect(function()
    ...
    if character and character:FindFirstChild("HumanoidRootPart") then
        ...
        successMsg.Position = UDim2.new(0.5, -125, 0, 350)
        successMsg.BackgroundTransparency = 1
        successMsg.Text = "Teleported to -1616, 67, -1873!"
        successMsg.TextColor3 = Color3.fromRGB(0, 255, 0)
        successMsg.Font = Enum.Font.Gotham
        successMsg.TextSize = 14
        successMsg.Parent = frame
...
teleportBtn5.MouseButton1Click:Connect(function()
    ...
    if character and character:FindFirstChild("HumanoidRootPart") then
        ...
        successMsg.Position = UDim2.new(0.5, -125, 0, 350)
        successMsg.BackgroundTransparency = 1
        successMsg.Text = "Teleported to 115, -26, -1483!"
        successMsg.TextColor3 = Color3.fromRGB(0, 255, 0)
        successMsg.Font = Enum.Font.Gotham
        successMsg.TextSize = 14
        successMsg.Parent = frame
...
-- Add a subtle background UIStroke for depth
